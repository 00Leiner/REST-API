...
router.put('/update/:scheduleID/:scheduleIDToUpdate', Schedule_1.updateScheduleItem);
router.delete('/delete/:scheduleID/:scheduleIDToDelete', Schedule_1.deleteScheduleItem);
